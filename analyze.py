...
def gather_result(asr:str, dataset:str, tool:str):
    ...
    for seed in [1, 2, 3]:
        ...
        for size in sizes:
            ...
            if tool in ["error_model", "error_model_without_diversity_enhancing", "asrevolve_error_model_real"] :
...
if __name__ == "__main__":
    ...
    tools = ["error_model", "error_model_without_diversity_enhancing", "asrevolve_error_model_real", "word_error_predictor_real/no_word_enhance", "word_error_predictor_real/word_enhance"]
    ...
    datasets = ["YBAA", "ZHAA", "ASI", "TNI", "NCC", "TXHC", "EBVS", "ERMS", "YDCK", "YKWK", "THV", "TLV"]
    tools = ["error_model_without_diversity_enhancing"]
