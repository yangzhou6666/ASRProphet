...
def finetune_deepspeech(train_csv_path, test_csv_path, gpu_id, load_checkpoint_dir, save_checkpoint_dir, output_dir, model_scorer, num_epochs, learning_rate):
    ...
    cmd = f"docker exec -it gpu{gpu_id}-deepspeech sh -c '" + \
            ...
            f"    --load_checkpoint_dir {load_checkpoint_dir}" + \
            f"    --save_checkpoint_dir {save_checkpoint_dir}" + \
            f"    --export_dir {output_dir}/" + \
            f"    --scorer {model_scorer};" + \
            f" ./convert_graphdef_memmapped_format --in_graph={output_dir}/output_graph.pb --out_graph={output_dir}/output_graph.pbmm'"
